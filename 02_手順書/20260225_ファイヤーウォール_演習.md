## FW接続
```bash
ssh -L 10443:172.31.2.10:443 -i ~/.ssh/entrycl_202601.pem ec2-user@16.144.198.187
```
...
2. NATとインターフェースの紐付け
    ...
    # ルール追加
    set security nat destination rule-set 1 rule 1A match destination-address 172.31.0.10/32
